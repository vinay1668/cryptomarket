...
import coinimg from "../images/cryptos/monero.png";
import bits from "../images/cryptos/moneroinfo.png";
...
function Moneroinfo() {
  ...
  useEffect(() =>{
    ...
    const getDetails = () => {
         ...
         axios.get("https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&ids=monero&order=market_cap_desc&per_page=100&page=1&sparkline=false")
        .then((response) =>{
     ...
     return(
         <div onLoad={getDetails}>
             <h1>Monero</h1>
            <img className="bitimg" src={coinimg}  alt ="monero" /> 
            <p>
            Monero is a privacy-focused cryptocurrency released in 2014. 
            It is an open-source protocol based on RandomX formerly CryptoNote.
            It uses an obfuscated public ledger, meaning anyone can send or broadcast transactions, but no outside observer can tell the source, amount, or destination.
            A proof of work mechanism is used to issue new coins and incentivize miners to secure the network and validate transactions..
            It has attracted users desiring privacy measures that are not provided in more popular cryptocurrencies. 
            However, it has also gained publicity for illicit use in darknet markets.
            ...
            <h1 className="retard" >Monero Market</h1>
           ...
           <h3 className="inner" style ={{position:"relative",top:"10px",left:"20px"}}>Monero Price</h3>
         ...
         <div
           ...
           <h3 className="inner" style ={{position:"relative",top:"10px",left:"5px",textAlign:"center"}}>Circulating Monero</h3>
           <h3 className="inner" style ={{position:"relative",top:"50px",textAlign:"center"}} class="card-text inner">{circulatingsupply}</h3>
         </div>

        
         <footer>
             <a className="end retarduno" href="https://blockchair.com/monero" >Blockchair/Monero</a>
             <a className="end retarddue" href="https://www.coingecko.com/en" >coingecko</a>
             <a className="end retardtre" href="https://www.getmonero.org/" >Monero.org</a>
