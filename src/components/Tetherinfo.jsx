...
import coinimg from "../images/cryptos/tether.png"
import bits from "../images/cryptos/tetherinfo.png";
...
function Tetherinfo() {
  ...
  useEffect(() =>{
    ...
    const getDetails = () => {
         ...
         axios.get("https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&ids=tether&order=market_cap_desc&per_page=100&page=1&sparkline=false")
        .then((response) =>{
     ...
     return(
         <div onLoad={getDetails}>
             <h1>Tether</h1>
            <img className="bitimg" src={coinimg}  alt ="tether" /> 
            <p>
            Tether is a controversial cryptocurrency with tokens issued by Tether Limited.
            It formerly falsely claimed that each token was backed by one United States dollar, 
            but on 14 March 2019 changed the backing to include loans to affiliate companies.The Bitfinex exchange was the subject of a lawsuit by the New York Attorney General of using Tether's funds to cover up $850 million in funds missing since mid-2018.
            ...
            <img style={{position:"absolute",width:"200px"}}className="bits" src={bits} alt="{bitcoin image}"/>


            <h1 className="retard" >Tether Market</h1>
           ...
           <h3 className="inner" style ={{position:"relative",top:"10px",left:"20px"}}>Tether Price</h3>
         ...
         <div
           ...
           <h3 className="inner" style ={{position:"relative",top:"10px",left:"5px",textAlign:"center"}}>Circulating Tether</h3>
           <h3 className="inner" style ={{position:"relative",top:"50px",textAlign:"center"}} class="card-text inner">{circulatingsupply}</h3>
         </div>

        
         <footer>
             <a className="end retarduno" href="https://blockchair.com/" >Blockchair</a>
             <a className="end retarddue" href="https://www.coingecko.com/en" >coingecko</a>
             <a className="end retardtre" href="https://tether.to/" >Tether</a>
